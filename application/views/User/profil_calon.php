    ...
    <div class="container-fluid">
      <?php if (empty($calon)) { ?>
        <div class="alert alert-danger">
          <h5><i class="icon fas fa-ban"></i> DATA CALON BELUM ADA</h5>
        </div>
      <?php } else { ?>
        <div class="row">
              ...
              <div class="card card-primary card-outline">
                <div class="card-body box-profile">
                  <div class="text-center">
                    <img class="profile-user-img img-fluid img-circle" src="<?= base_url('upload/') ?>foto/<?= $row->foto ?>" onerror="this.src='<?= base_url('assets/') ?>dist/img/default.png'" alt="Foto Calon">
                  </div>
